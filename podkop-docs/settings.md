...
Источник: https://podkop.net/docs/settings/
...
> **Note:** Экспериментальная опция, возможно будет убрана в дальнейшем.
...
`Yacd (Clash API)` представляет собой дополнительную веб-панель, в которой вы можете увидеть уходят ли соединения в туннель, потребление памяти и правила, используемые `sing-box`.
...
Подробнее: [dont-touch-my-dhcp.md](dont-touch-my-dhcp.md)
...
Позволяет исключить направление трафика NTP-протокола в туннель/proxy.
